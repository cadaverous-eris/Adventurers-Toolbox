...
public class MaceModel implements IModel, IRetexturableModel, IModelCustomData {
	...
	private static final class BakedMaceModel implements IPerspectiveAwareModel {

		private final MaceModel parent;
