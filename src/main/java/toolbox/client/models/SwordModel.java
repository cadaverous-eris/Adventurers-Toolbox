...
public class SwordModel implements IModel, IRetexturableModel, IModelCustomData {
	...
	private static final class BakedSwordModel implements IPerspectiveAwareModel {

		private final SwordModel parent;
