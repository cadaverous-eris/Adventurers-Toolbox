...
public class PickaxeModel implements IModel, IRetexturableModel, IModelCustomData {
	...
	private static final class BakedPickaxeModel implements IPerspectiveAwareModel {

		private final PickaxeModel parent;
