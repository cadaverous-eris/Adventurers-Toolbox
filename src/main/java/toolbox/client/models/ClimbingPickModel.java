...
public class ClimbingPickModel implements IModel, IRetexturableModel, IModelCustomData {
	...
	private static final class BakedClimbingPickModel implements IPerspectiveAwareModel {

		private final ClimbingPickModel parent;
