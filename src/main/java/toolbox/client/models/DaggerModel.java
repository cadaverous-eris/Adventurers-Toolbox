...
public class DaggerModel implements IModel, IRetexturableModel, IModelCustomData {
	...
	private static final class BakedDaggerModel implements IPerspectiveAwareModel {

		private final DaggerModel parent;
